...
from dataset import CodeDataset, mel_spectrogram, get_dataset_filelist, make_train_val_filelist
...
def train(rank, local_rank, a, h):
    ...
    training_filelist, validation_filelist = make_train_val_filelist(h.input_training_file)
